...
function IconGoogle(p) {
  return (
    <svg viewBox="0 0 24 24" {...p}>
      <path fill="#4285F4" d="M22.5 12.2c0-.7-.06-1.4-.18-2H12v3.8h5.9a5 5 0 0 1-2.2 3.3v2.7h3.6c2.1-2 3.3-4.9 3.3-7.8z"/>
      <path fill="#34A853" d="M12 23c3 0 5.5-1 7.3-2.7l-3.6-2.7c-1 .67-2.3 1.05-3.7 1.05-2.85 0-5.27-1.92-6.13-4.5H2.2v2.8A11 11 0 0 0 12 23z"/>
      <path fill="#FBBC05" d="M5.87 14.15a6.6 6.6 0 0 1 0-4.3V7.05H2.2a11 11 0 0 0 0 9.9z"/>
      <path fill="#EA4335" d="M12 5.4c1.6 0 3 .55 4.13 1.62l3.1-3.1A11 11 0 0 0 2.2 7.05l3.67 2.8C6.73 7.32 9.15 5.4 12 5.4z"/>
    </svg>
  )
}
